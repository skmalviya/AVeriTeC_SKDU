...
nli_dataset_path = "datasets/dev_train_mnli.tsv.gz"
...
train_batch_size = 8
num_epochs = 4
model_save_path = "output/training_averitec_nli-" + datetime.now().strftime("%Y-%m-%d_%H-%M-%S")

# Define our CrossEncoder model. We use distilroberta-base as basis and setup it up to predict 3 labels
model = CrossEncoder("microsoft/deberta-v3-base", num_labels=len(label2int), tokenizer_args={"use_fast": False})

    ...
    def process(self, input_dir, output_dir, data_generator, tokenizer, dataset = ["train", "dev", "test"]):
        ...
        if "test" in dataset:
            self.test_data = data_generator(
                os.path.join(input_dir, "test.scorecheck.jsonl")

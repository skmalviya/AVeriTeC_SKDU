...
class BasicModule(nn.Module):
    ...
    def load(self, path, strict = True):
        ...
        other_keys = self.load_state_dict(state_dict, strict=strict)
    ...
    def save(self, ckpt_root_dir, ckpt_meta, valid_val, suffix, only_max=True):
        if self.subdir == None or only_max is False:
            self.subdir = "{}_{}_{}".format(self.model_name, time.strftime('%m%d_%H:%M:%S'), suffix)
